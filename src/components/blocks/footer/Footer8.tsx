        ...
        <div className="row gy-6 gy-lg-0">
          <div className="col-md-4 col-lg-3">
            <div className="widget">
              <img className="mb-4" src="/img/elio-logo-small-white.png" srcSet="/img/elio-logo-small-white.png 2x" alt="" />
          ...
          <div className="col-md-4 col-lg-3">
            <div className="widget">
              ...
              <address className="pe-xl-15 pe-xxl-17">London, United Kingdom</address>
              <NextLink title="business@elio.agency" href="mailto:business@elio.agency" />
            </div>
          </div>
