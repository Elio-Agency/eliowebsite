        ...
        <div className="card-body p-10 p-xl-12">
          <div className="row text-center">
            <div className="col-xl-11 col-xxl-9 mx-auto">
              <h2 className="fs-16 text-uppercase text-white mb-3">Let's get started</h2>
              <h3 className="display-3 mb-8 px-lg-8 text-white">
                We are <span className="underline-3 style-2 yellow">trusted</span> by over 100+ clients. Join them now
                and make software work for you.
              </h3>
            </div>
          </div>
