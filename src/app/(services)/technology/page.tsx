        ...
        <div className="container pt-10 pb-19 pt-md-14 pb-md-20 text-center">
          <div className="row">
            <div className="col-md-8 col-lg-7 col-xl-6 col-xxl-5 mx-auto mb-11">
              <h1 className="display-1 mb-3">Technology</h1>
              <p className="lead px-lg-7 px-xl-7 px-xxl-6">
                Our team of experienced developers can provide you with the solutions that your business needs.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="wrapper bg-light angled upper-end">
        <div className="container pb-14 pb-md-16">
          ...
          <div className="row mb-8">
            <div className="col-12 mt-n20 mb-10">
