...
import {EZoneProjectDetailsContent} from "components/common/eZoneProjectDetailsContent";
// CUSTOM DATA
            ...
            <div className="row">
              <div className="col-md-10 col-lg-8 col-xl-7 mx-auto">
                <div className="post-header">
                  ...
                  <h1 className="display-1 mb-3">eZone Logistics</h1>
                  <p className="lead px-md-12 px-lg-12 px-xl-15 px-xxl-18">
                    Increasing brand awareness and sign ups through social media.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-12">
                <article className="mt-n21">
                  ...
                  <EZoneProjectDetailsContent title="About the Project"/>
