...
import {LDSProjectDetailsContent}  from "components/common/LDSProjectDetailsContent";
import ProjectDetailsNavigation from "components/common/ProjectDetailsNavigation";
// CUSTOM DATA
const images = ["/img/photos/pp2.jpg", "/img/photos/pp3.jpg"];

export default function LDSProjectDetails() {
              ...
              <div className="col-md-10 col-lg-8 col-xl-7 mx-auto">
                <div className="post-header">
                  <div className="post-category text-line">
                    <NextLink title="Marketing" href="#" className="hover" />
                  </div>

                  <h1 className="display-1 mb-3">Leak Detection Specialists</h1>
                  <p className="lead px-md-12 px-lg-12 px-xl-15 px-xxl-18">
                    Generating impressions and leads through social media marketing.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-12">
                <article className="mt-n21">
                  ...
                  <LDSProjectDetailsContent title="About the Project" />
