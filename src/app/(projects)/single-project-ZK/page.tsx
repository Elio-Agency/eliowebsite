...
export default function ZKProjectDetails() {
            ...
            <div className="row">
              <div className="col-md-10 col-lg-8 col-xl-7 mx-auto">
                <div className="post-header">
                  ...
                  <h1 className="display-1 mb-3">Lead Generation</h1>
                  <p className="lead px-md-12 px-lg-12 px-xl-15 px-xxl-18">
                    Generating leads for artists in the tattoo industry.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-12">
                <article className="mt-n21">
                  ...
                  <ZKProjectDetailsContent title="About the Project" />
