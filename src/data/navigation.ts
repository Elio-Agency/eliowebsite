...
const projectsNavigation = [
  {
    title: "TECHNOLOGY",
    children: [
      { id: 1, title: "Clash Of Clans", url: "/single-project-clash-of-clans" },
      { id: 2, title: "Superdry", url: "/single-project-superdry" },
      { id: 3, title: "Car and Classic", url: "/single-project-car-and-classic" }
    ]
  },
  {
    title: "MARKETING",
    children: [
      { id: 1, title: "Plumbing | Social Media", url: "/single-project-LDS" },
      { id: 2, title: "Logistics | Marketing", url: "/single-project-eZone" },
      { id: 3, title: "Tattoo Artists | Lead Gen", url: "/single-project-ZK" }
    ]
  }
];
