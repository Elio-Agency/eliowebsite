...
export const aboutList4 = [
  {
    ...
    color: 'fuchsia',
    title: 'Creativity',
    description: 'Our in house marketing team can make any business stand out.'
  },
  {
    id: 2,
    Icon: Bulb,
    ...
    description: 'No two business problems are the same, we think outside the box.'
  },
  {
    id: 3,
    Icon: Puzzle,
    ...
    description: 'Our agile methodologies allow us to move faster than the competition.'
  },
  {
    id: 4,
    Icon: Headphone,
    ...
    description: 'We are always here to help, no matter the time or day.'
  }
];
